...
import { useSale, useSalePayments, useSaleReturns } from "@/hooks/use-sales";
              ...
              {stat.isStatus ? (
                <Badge
                  className={cn(
                    ...
                    stat.value === "PAID" && "bg-emerald-100 text-emerald-700",
          ...
          <div className="space-y-3">
            ...
            {payments.length === 0 ? (
              ...
              payments.map((p: SalePayment) => (
                <div
                  key={p.id}
                  className="flex items-center justify-between rounded-2xl border bg-white p-4 shadow-sm transition-all hover:border-violet-200"
                >
